...
export default function KBLandingPage() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-12">
      ...
      <p className="text-on-surface-muted mb-12 max-w-2xl">
        ...
        {KB_CATEGORIES.map(category => {
          ...
          return (
            ...
            >
              ...
              <p className="text-sm font-medium text-on-surface mb-1">{meta.description}</p>
              <p className="text-sm text-on-surface-muted leading-relaxed">{meta.purpose}</p>
            </Link>
          )
        })}
      </div>
