  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        {steps.map(step => (
          <details key={step.number} className="border border-border rounded-radius-lg">
            <summary className="px-4 py-3 text-sm font-medium text-on-surface cursor-pointer hover:text-on-surface select-none">
              Step {step.number} — {step.playTitle}
            </summary>
            <pre className="px-4 pb-4 text-xs text-on-surface-muted font-mono whitespace-pre-wrap leading-relaxed overflow-auto max-h-64 border-t border-border pt-3">
